...
/*select CompanyName, Concat(FirstName+' ', LastName) as CustomerContactName, sum(LineTotal) as TotalRevenue
from SalesLT.Customer as c
join SalesLT.SalesOrderHeader as oh
on c.CustomerID = oh.CustomerID
join SalesLT.SalesOrderDetail as od
on oh.SalesOrderID = od.SalesOrderID
group by CompanyName, Concat(FirstName+' ', LastName)
order by CompanyName, CustomerContactName*/

with CustSalesRevenue(CompanyName, CustomerContactName, LineTotal)
as
(
	select CompanyName, Concat(FirstName+' ', LastName) as CustomerContactName, LineTotal
	from SalesLT.Customer as c
	join SalesLT.SalesOrderHeader as oh
	on c.CustomerID = oh.CustomerID
	join SalesLT.SalesOrderDetail as od
...
select CompanyName, CustomerContactName, SUM(LineTotal) as TotalRevenue
